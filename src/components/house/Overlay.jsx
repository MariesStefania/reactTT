...
const Section = (props) => {
  return (
    ...
    >
      <div style={{ "margin-right": "610px" }}>
        <div>
          <div style={{ background: "#F7EFE6" }}>{props.children}</div>
        </div>
      </div>
    </section>
  );
    ...
    <Scroll html>
      <div>
        <Section opacity={opacityFirstSection}>
          <h1 style={{ "margin-left": "10px" }}>O reprezentare a camerelor</h1>
          <p style={{ "margin-left": "10px", "margin-right": "10px" }}>
            Model 3d realizat in blender si exportat in aplicatii web
          </p>
        ...
        <Section2 right opacity={opacitySecondSection} mLeft={"800px"}>
          ...
          <p style={{ "margin-left": "10px" }}>
            printr-un scroll se ajunge oriunde
          </p>
          <p style={{ "margin-left": "10px" }}>
          ...
          <p style={{ "margin-left": "10px" }}>
            toate posibile datorita ThreeJs
          </p>
        ...
        <Section3 opacity={opacityLastSection}>
          <h1 style={{ "margin-left": "10px" }}>Cea mai buna librarie</h1>
          <p style={{ "margin-left": "10px" }}>
            De la modelare 3D la aplicatii web
          </p>
          <p style={{ "margin-left": "10px" }}>experiente imersive</p>
        </Section3>
      </div>
    </Scroll>
  );
