...
export default function Bulele({ speed = 1, count = 80, depth = 80, easing = (x) => Math.sqrt(1 - Math.pow(x - 1, 2)) }) {
  return (
    ...
    {/* <OrbitControls enableZoom={false}/> */}
      ...
      {Array.from({ length: count }, (_, i) => <Bule key={i} index={i} z={Math.round(easing(i / count) * depth)} speed={speed} /> /* prettier-ignore */)}
